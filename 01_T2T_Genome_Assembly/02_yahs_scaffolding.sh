...
juicer post -o out_JBAT out_JBAT.review.assembly out_JBAT.liftover.agp asm.fa #asm.fa is HiFiasm fasta assembly (It's also the same as contigs.fa, the reason I made a different name is that I'm just following from GitHub)
haphic plot out_JBAT.FINAL.agp Kandeliaobovata.filtered.bam
...
haphic plot out_JBAT_new.FINAL.agp kandelia.filtered.bam --specified_scaffolds scaffold_1,scaffold_18 #if only 2 scaffolds
haphic plot out_JBAT_new.FINAL.agp kandelia.filtered.bam --specified_scaffolds scaffold_1,scaffold_2,scaffold_3,scaffold_4,scaffold_5,scaffold_6,scaffold_7,scaffold_8,scaffold_9,scaffold_10,scaffold_11,scaffold_12,scaffold_13,scaffold_14,scaffold_15,scaffold_16,scaffold_17,scaffold_18
